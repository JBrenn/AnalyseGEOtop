...
inputPanel(
  ...
  selectInput(inputId = "add_variable", label = "additional variable", choices = dimnames(obs$day)[[2]], selected = "rainfall_amount"),
...
#     scatter.rcharts <- rPlot(simulation ~ observation, data = data, type = 'point')
